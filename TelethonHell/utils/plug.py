...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        LOGS.info("Saif User Bot - Successfully imported " + shortname)
    else:
        import TelethonHell.utils
        ...
        LOGS.info("⚡ 𝐒αιғβσтƨ ⚡- Successfully Imported " + shortname)
...
async def plug_channel(client, channel):
    if channel != 0:
        LOGS.info("⚡ 𝐒αιғβσтƨ ⚡ - PLUGIN CHANNEL DETECTED.")
        LOGS.info("⚡ 𝐒αιғβσтƨ ⚡ - Starting to load extra plugins.")
