...
CmdHelp("𝐀ʀᴛs").add_command(
    "ᴇʟᴏᴠᴇ", None, "Use and see"
).add_command(
    "ᴍᴏɴsᴛᴇʀ", None, "Use and see"
).add_command(
    "ᴘɪɢ", None, "Use and see"
).add_command(
    "ɢᴜɴ", None, "Use and see"
).add_command(
    "ᴅᴏɢ", None, "Use and see"
).add_command(
    "ʜᴇʟʟᴏ", None, "Use and see"
).add_command(
    "ʜᴍғ", None, "Use and see"
).add_command(
    "ᴄᴏᴜᴘʟᴇ", None, "Use and see"
).add_command(
    "sᴜᴘ", None, "Use and see"
).add_command(
    "ɪɴᴅɪᴀ", None, "Use and see"
).add_command(
    "ᴡᴄ", None, "Use and see"
).add_command(
    "sɴᴋ", None, "Use and see"
).add_command(
    "ʙʏᴇ", None, "Use and see"
).add_command(
    "sʜɪᴛᴏs", None, "Use and see"
).add_command(
    "ᴅɪsʟɪᴋᴇ", None, "Use and see"
).add_command(
    "ᴄᴀʀʀʏ", "<text>", "send your text with carry art"
).add_command(
    "ded", "<text>", "Hang yourself"
).add_command(
    "sᴛʜɪɴᴋ", "<text>", "Send your text in thinking art"
).add_command(
    "sғʀᴏɢ", "<text>", "Send your text in frog art"
).add_command(
    "sᴅᴇᴀᴅ", "<text>", "Send your text in dear frog art"
).add_command(
    "sᴛʀᴜᴍᴘ", "<text>", "Send your text in trump art"
).add_command(
    "ᴄʜɪɴᴀ", "<text>", "Send your text in china art"
).add_command(
    "ssʜɪᴛ", None, 'Send a art in "Ahh shit. Here we go again"'
).add_info(
    "Artistic Module"
).add_warning(
    "✅ Harmless Module."
